...
- **Barren Plateau**: "the training landscape of many (parameterized quantum circuit) have been shown to be exponentially flat with respect to circuit size, making gradient descent impossible" [^DiffInt]
